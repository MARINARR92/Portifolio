...
const services = [
  {
    name: 'UI/UX Design',
    description: 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Optio aperiam aliquam error animi dolorem',
    link: 'Learn more'
  },
  {
    name: 'Development',
    ...
    <div className='border-b border-white/20 h-[146px] mb-[38px]
                  flex'>
                    <div className='max-w-[476px]'>
                      ...
                      <h6 className='text-[16px] font-medium'>Centro Universitário de Formiga</h6>
                    </div>
      ...
      <div className='border-b border-white/20 h-[146px] mb-[38px]
                  flex'>
                    <div className='max-w-[476px]'>
                      ...
                      <h6 className='text-[16px] font-medium'>Instituto Federal de Educação, Ciência e Tecnologia de Minas Gerais</h6>
                    </div>
     ...
     <h2 className='h2 text-accent'>Experiências</h2>
      ...
      <div className='border-b border-white/20 h-[300px] mb-[38px]
                  flex'>
                    <div className='max-w-[476px]'>
                      <h4 className='text-[14px] font-semibold my-2.5 text-gradient'>jan de 2010 - atual</h4>
